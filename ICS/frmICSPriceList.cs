...
namespace Xtreme
{
	internal partial class frmICSPriceList
		: System.Windows.Forms.Form
	{

		public frmICSPriceList()
{
InitializeComponent();
} 
 public  void frmICSPriceList_old()
			//: base()
		{
		...
		private void frmICSPriceList_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		private void chkContinuous_CheckStateChanged(Object eventSender, EventArgs eventArgs)
		{
			if (chkContinuous.CheckState == CheckState.Unchecked)
			{
				txtDEfectStartDate.Enabled = true;
				txtDEfectEndDate.Enabled = true;
			}
			else
			{
				txtDEfectStartDate.Enabled = false;
				txtDEfectEndDate.Enabled = false;
				txtDEfectStartDate.Text = "";
				txtDEfectEndDate.Text = "";
			}
		}
		...
		private void Form_Load()
		{
			...
			try
			{
				...
				txtpListNo.Text = SystemProcedure2.GetNewNumber("ICS_Price_List", "Price_List_No");
				txtDDate.Value = DateTime.Today;
				txtDEfectStartDate.Text = "";
				txtDEfectEndDate.Text = "";
		...
		public bool saveRecord()
		{
			...
			try
			{
				...
				if (chkContinuous.CheckState == CheckState.Unchecked && Convert.IsDBNull(txtDEfectStartDate.Value))
				{
					MessageBox.Show(" Enter Effect Start Date. ", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()), MessageBoxButtons.OK, MessageBoxIcon.Information);
					txtDEfectStartDate.Focus();
					return result;
				}
				//UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
				if (chkContinuous.CheckState == CheckState.Unchecked && Convert.IsDBNull(txtDEfectEndDate.Value))
				{
					MessageBox.Show(" Enter Effect End Date. ", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()), MessageBoxButtons.OK, MessageBoxIcon.Information);
					txtDEfectEndDate.Focus();
					return result;
				}
				...
				{
					mysql = "insert into ICS_Price_List (user_cd, Price_List_No,Price_List_Date, Price_List_L_Name, Price_List_A_Name, Continuous, Effective_Start_Date,Effective_End_Date,Comments)  ";
					mysql = mysql + " values (" + Conversion.Str(SystemVariables.gLoggedInUserCode) + ",";
					mysql = mysql + Conversion.Str(txtpListNo.Text) + ",";
					mysql = mysql + "'" + ReflectionHelper.GetPrimitiveValue<string>(txtDDate.Value) + "',";
					mysql = mysql + "'" + txtLPListName.Text + "',";
					mysql = mysql + "N'" + txtAPListName.Text + "',";
					mysql = mysql + ((int) chkContinuous.CheckState).ToString() + " ,";
					if (chkContinuous.CheckState == CheckState.Unchecked)
					{
						mysql = mysql + "'" + ReflectionHelper.GetPrimitiveValue<string>(txtDEfectStartDate.Value) + "',";
						mysql = mysql + "'" + ReflectionHelper.GetPrimitiveValue<string>(txtDEfectEndDate.Value) + "',";
					}
					else
					{
						mysql = mysql + "null, ";
				...
				else
				{
					...
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["Price_List_No"].setValue(txtpListNo.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["Price_List_Date"].setValue(ReflectionHelper.GetPrimitiveValue(txtDDate.Value));
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["Price_List_L_Name"].setValue(txtLPListName.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["Price_List_A_Name"].setValue(txtAPListName.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["Continuous"].setValue((int) chkContinuous.CheckState);
					if (chkContinuous.CheckState == CheckState.Unchecked)
					{
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
						withVar.Tables[0].Rows[0]["Effective_Start_Date"].setValue(ReflectionHelper.GetPrimitiveValue(txtDEfectStartDate.Value));
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
						withVar.Tables[0].Rows[0]["Effective_End_Date"].setValue(ReflectionHelper.GetPrimitiveValue(txtDEfectEndDate.Value));
					}
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
			...
			catch (System.Exception excep)
			{
				...
				if (mReturnErrorType == 1)
				{
					...
					mSearchValue = ReflectionHelper.GetPrimitiveValue(SystemProcedure2.GetMasterCode("select Price_List_Cd from ICS_Price_List where Price_List_No= " + txtpListNo.Text));
		...
		public void GetRecord(object SearchValue)
		{
			...
			try
			{
				...
				try
				{
					...
					mysql = " select * from ICS_Price_List where Price_List_Cd = '" + ReflectionHelper.GetPrimitiveValue<string>(SearchValue) + "'";
					...
					{
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtpListNo.Text = Convert.ToString(withVar.Tables[0].Rows[0]["Price_List_No"]);
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtDDate.Value = withVar.Tables[0].Rows[0]["Price_List_Date"];
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtLPListName.Text = Convert.ToString(withVar.Tables[0].Rows[0]["Price_List_L_Name"]);
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtAPListName.Text = Convert.ToString(withVar.Tables[0].Rows[0]["Price_List_A_Name"]) + "";
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						...
						chkContinuous.CheckState = (CheckState) ((Convert.ToBoolean(withVar.Tables[0].Rows[0]["Continuous"])) ? 1 : 0);
						if (chkContinuous.CheckState == CheckState.Unchecked)
						{
							//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
							txtDEfectStartDate.Value = withVar.Tables[0].Rows[0]["Effective_Start_Date"];
							txtDEfectStartDate.Enabled = true;
						}
						else
						{
						...
						{
							//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
							txtDEfectEndDate.Value = withVar.Tables[0].Rows[0]["Effective_End_Date"];
							txtDEfectEndDate.Enabled = true;
						}
						else
						{
						...
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtComment.Text = (withVar.Tables[0].Rows[0].IsNull("Comments")) ? "" : Convert.ToString(withVar.Tables[0].Rows[0]["Comments"]);
		...
		{
			SystemReports.GetSystemReport(52020017, 1);
		...
		public void findRecord()
		{
			...
			object mTempSearchValue = ReflectionHelper.GetPrimitiveValue(SystemProcedure.FindItem(2009010));
			//UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
		...
		public bool CheckDataValidity()
		{
			...
			if (!Information.IsNumeric(txtpListNo.Text))
			{
				MessageBox.Show("Enter the Price List Code", "Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
				txtpListNo.Focus();
				return false;
			}
			return true;
		...
		private void Form_Closed(Object eventSender, EventArgs eventArgs)
		{
			...
			try
			{
				...
				UserAccess = null;
				localRec = null;
				frmICSPriceList.DefInstance = null;
		...
		private void txtUnitNo_DropButtonClick()
		{
			GetNextNumber();
		}
