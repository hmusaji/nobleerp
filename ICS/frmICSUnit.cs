...
namespace Xtreme
{
	internal partial class frmICSUnit
...
InitializeComponent();
 ...
 public  void frmICSUnit_old()
		...
		private void frmICSUnit_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		//frmSysMain.RibbonBar().FindTab(1).Visible = True
		//frmSysMain.RibbonBar.Tab(frmSysMain.RibbonBar().FindTab(1).Index).Selected = True
		//End Sub
		//
		//Private Sub Form_Deactivate()
		//frmSysMain.RibbonBar().FindTab(1).Visible = False
		//frmSysMain.RibbonBar.Tab(frmSysMain.RibbonBar().FindTab(1).Index).Selected = False
		//End Sub
		...
		private void Form_Load()
		{
			...
			try
			{
				...
				txtUnitNo.Text = SystemProcedure2.GetNewNumber("ICS_unit", "unit_no");
		...
		public bool saveRecord()
		{
			...
			try
			{
				...
				{
					mysql = "insert into ICS_Unit (user_cd, unit_no, l_unit_name, a_unit_name, symbol, decimals)  ";
					mysql = mysql + " values (" + Conversion.Str(SystemVariables.gLoggedInUserCode) + ",";
					mysql = mysql + Conversion.Str(txtUnitNo.Text) + ",";
					mysql = mysql + "'" + txtLUnitName.Text + "',";
					mysql = mysql + "N'" + txtAUnitName.Text + "',";
					mysql = mysql + "'" + txtSymbol.Text + "',";
					mysql = mysql + txtDecimal.Text + ")";
				...
				else
				{
					...
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["unit_no"].setValue(txtUnitNo.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["l_unit_name"].setValue(txtLUnitName.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
					withVar.Tables[0].Rows[0]["a_unit_name"].setValue(txtAUnitName.Text);
					//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
					//UPGRADE_ISSUE: (2064) ADODB.Field20 property Fields.Value was not upgraded. More Information: https://docs.mobilize.net/vbuc/ewis#2064
			...
			catch (System.Exception excep)
			{
				...
				if (mReturnErrorType == 1)
				{
					...
					mSearchValue = ReflectionHelper.GetPrimitiveValue(SystemProcedure2.GetMasterCode("select unit_cd from ICS_Unit where unit_no= " + txtUnitNo.Text));
		...
		public void GetRecord(object SearchValue)
		{
			...
			try
			{
				...
				try
				{
					...
					mysql = " select * from ICS_Unit where unit_cd = '" + ReflectionHelper.GetPrimitiveValue<string>(SearchValue) + "'";
					...
					{
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtUnitNo.Text = Convert.ToString(withVar.Tables[0].Rows[0]["unit_no"]);
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtSymbol.Text = Convert.ToString(withVar.Tables[0].Rows[0]["symbol"]);
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtLUnitName.Text = Convert.ToString(withVar.Tables[0].Rows[0]["l_unit_name"]);
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
						txtAUnitName.Text = Convert.ToString(withVar.Tables[0].Rows[0]["a_unit_name"]) + "";
						//UPGRADE_WARNING: (2077) Change the default 0 index in the Rows property with the correct one. More Information: https://docs.mobilize.net/vbuc/ewis#2077
		...
		public void findRecord()
		{
			...
			object mTempSearchValue = ReflectionHelper.GetPrimitiveValue(SystemProcedure.FindItem(2005000));
			//UPGRADE_WARNING: (1049) Use of Null/IsNull() detected. More Information: https://docs.mobilize.net/vbuc/ewis#1049
		...
		public bool CheckDataValidity()
		{
			...
			if (!Information.IsNumeric(txtUnitNo.Text))
			{
				MessageBox.Show("Enter the ICS_Unit Code", "Required", MessageBoxButtons.OK, MessageBoxIcon.Information);
				txtUnitNo.Focus();
				return false;
			}
			return true;
		...
		private void txtUnitNo_DropButtonClick(Object Sender, EventArgs e)
		{
			GetNextNumber();
		}
		...
		public void GetNextNumber()
		{
			...
			txtUnitNo.Text = SystemProcedure2.GetNewNumber("unit", "unit_no");
			txtUnitNo.Focus();
		}
	}
}