...
namespace Xtreme
{
	partial class frmICSBarcodeDataCollection
	{
		...
		public AxC1Elastic conImportICSTrans;
		...
		public AxC1Elastic conImportGLVoucher;
		...
		private void InitializeComponent()
		{
			...
			this.conImportICSTrans = new AxC1Elastic();
			this.conImportGLVoucher = new AxC1Elastic();
			...
			this.conFileImport = new AxC1Elastic();
