...
namespace Xtreme
{
	partial class frmPayIndemnityAccrualSummary
	{

		#region "Upgrade Support "
		private static frmPayIndemnityAccrualSummary m_vb6FormDefInstance;
		private static bool m_InitializingDefInstance;
		public static frmPayIndemnityAccrualSummary DefInstance
		{
			get
			{
		...
		public static frmPayIndemnityAccrualSummary CreateInstance()
		{
			frmPayIndemnityAccrualSummary theInstance = new frmPayIndemnityAccrualSummary();
		...
		private void InitializeComponent()
		{
			...
			//System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPayIndemnityAccrualSummary));
			...
			//this.Icon = (System.Drawing.Icon) resources.GetObject("frmPayIndemnityAccrualSummary.Icon");
			this.KeyPreview = true;
			this.Location = new System.Drawing.Point(124, 221);
			this.MaximizeBox = true;
			this.MinimizeBox = true;
			this.Name = "frmPayIndemnityAccrualSummary";
			this.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Tag = "\"H: 6225  W:9570\"";
			this.Text = "Indemnity Accrual Summary";
			// this.Activated += new System.EventHandler(this.frmPayIndemnityAccrualSummary_Activated);
