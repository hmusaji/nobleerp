...
namespace Xtreme
{
	internal partial class frmPayEmployeeRegister
		: System.Windows.Forms.Form
	{

		public frmPayEmployeeRegister()
{
InitializeComponent();
} 
 public  void frmPayEmployeeRegister_old()
			//: base()
		{
		...
		private void frmPayEmployeeRegister_Activated(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		{
			FirstFocusObject = txtCommonTextBox[1];
			...
			switch(mIndex)
			{
				case 1 : 
					...
					if (!Convert.IsDBNull(mTempSearchValue))
					{
						...
						txtCommonTextBox[1].Text = ReflectionHelper.GetPrimitiveValue<string>(((Array) mTempSearchValue).GetValue(1));
