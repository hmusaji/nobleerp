...
namespace Xtreme
{
	partial class frmSysReportMultiSelect
	{

		#region "Upgrade Support "
		private static frmSysReportMultiSelect m_vb6FormDefInstance;
		private static bool m_InitializingDefInstance;
		public static frmSysReportMultiSelect DefInstance
		{
			get
			{
		...
		public static frmSysReportMultiSelect CreateInstance()
		{
			frmSysReportMultiSelect theInstance = new frmSysReportMultiSelect();
		...
		//private string[] visualControls = new string[]{"components", "ToolTipMain", "_chkCommonSettings_1", "_chkCommonSettings_0", "txtCriteriaBox", "_btnReportOptions_5", "lblFindResult", "lblRecordsCriteria", "grdRecordsCriteria", "grdFindResult", "lblTips1", "tcbSystemForm", "fraOuterShadow", "mnuColors", "btnReportOptions", "chkCommonSettings", "commandButtonHelper1"};
		...
		private void InitializeComponent()
		{
			...
			//System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmSysReportMultiSelect));
			...
			this._chkCommonSettings_1.TabIndex = 3;
			...
			this._chkCommonSettings_0.TabIndex = 2;
			...
			this._btnReportOptions_5.TabIndex = 0;
			...
			this.lblRecordsCriteria.TabIndex = 5;
			...
			this.grdRecordsCriteria.TabIndex = 6;
			...
			this.Name = "frmSysReportMultiSelect";
