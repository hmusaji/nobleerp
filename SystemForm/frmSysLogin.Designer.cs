...
namespace Xtreme
{
	partial class frmSysLogin
	{
		...
		private void InitializeComponent()
		{
			...
			this.chkSaveUser.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.chkSaveUser.CheckState = System.Windows.Forms.CheckState.Checked;
			this.chkSaveUser.Enabled = true;
			...
			this.chkSaveUser.TabStop = true;
			this.chkSaveUser.Text = "Save User Name";
			this.chkSaveUser.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.chkSaveUser.Visible = true;
			// 
			// chkSavePassword
			// 
			...
			this.chkSavePassword.CheckAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.chkSavePassword.CheckState = System.Windows.Forms.CheckState.Unchecked;
			...
			this.chkSavePassword.TabStop = true;
			this.chkSavePassword.Text = "Save Password";
			this.chkSavePassword.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.chkSavePassword.Visible = true;
			// 
			// cmdVerify
			// 
			...
			// this.this.txtPassword.PasswordChar = "108";
			...
			// this.this.txtPassword.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtPassword_KeyPress);
			// 
			// txtUserID
			// 
			...
			// this.this.BackgroundImage = (System.Drawing.Image) resources.GetObject("frmSysLogin.BackgroundImage");
			...
			//this.Controls.Add(this.mnuSystemMenu);
			////this.Icon = (System.Drawing.Icon) resources.GetObject("frmSysLogin.Icon");
			...
			//this.commandButtonHelper1.SetStyle(this.cmdVerify, 1);
			// this.Activated += new System.EventHandler(this.frmSysLogin_Activated);
